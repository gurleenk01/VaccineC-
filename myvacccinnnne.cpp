...
void Vaccine::search_by_gender()//6.4
{
    ...
    if(flag==0)
    {
    cout<<"SORRY!! No people of this Gender is vaccinated."<<endl;
    }
    cout<<"\n\n\n NO. of people vaccinated of this gender: "<<p<<endl;
    in.close();
}
//-------------------------------------------------------------------------
...
int password()//b
{
    ...
    cin>>capt;
    if( (strcmp(cname,"k01gurleen")==0) && (strcmp(pass,"jaskaran10@")==0) && cap==capt)
        return 1;
    else
        return 0;
}
